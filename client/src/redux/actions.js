 ...
 */
const ENDPOINT = "https://huellitas-de-amor.up.railway.app/mascotas/";
const ENDPOINT_FILTER = "https://huellitas-de-amor.up.railway.app/mascotas/filtro";
const ENDPOINTNAME2 = "https://huellitas-de-amor.up.railway.app/mascotas/nombre?nombre=";
const ENDPOINTNAME = "https://huellitas-de-amor.up.railway.app/mascotas?name=";
...
export const getUsers = () => async(dispatch) => {
  try{
    const response =  await axios.get('https://huellitas-de-amor.up.railway.app/usuario')
    dispatch({
      type: GET_USERS,
      payload: response.data
    })
...
export const getAllHomes = () => async(dispatch) => {
  try{
    const response =  await axios.get('https://huellitas-de-amor.up.railway.app/casaDeAdopcion')
    dispatch({
      type: GET_ALL_HOMES,
      payload: response.data
    })
...
export const getDonations = () => async(dispatch) => {
  try{
    const response =  await axios.get('https://huellitas-de-amor.up.railway.app/donaciones/')
    dispatch({
...
export const editUser = (id, updatedData)  => {
  const endpoint = `https://huellitas-de-amor.up.railway.app/usuario/${id}`;
...
export const editPets = (id, updatedData)  => {
  const endpoint = `https://huellitas-de-amor.up.railway.app/mascotas/${id}`;
...
export const deleteHouses = (id) => {
  const endpoint = `https://huellitas-de-amor.up.railway.app/casaDeAdopcion/${id}`;
   return (dispatch) => {
      axios.delete(endpoint).then(({ data }) => {
         return dispatch({
            type: DELETE_USERS,
